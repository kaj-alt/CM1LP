...
!==================================================================================================!
 ...
 subroutine p3_init(lookup_file_dir,nCat,model,stat,abort_on_err,dowr)
...
! read in ice microphysics table
 ...
 if(dowr) print*
 if(dowr) print*, ' P3 microphysics: v',version_p3
 if(dowr) print*, '   P3_INIT (reading/creating look-up tables [v',trim(version_intended_table_1), &
 ...
 if (trim(version_intended_table_1) /= trim(version_header_table_1)) then
    ...
    if(dowr) print*, ' Loading lookupTable_1: v',trim(version_header_table_1)
