  ...
  CONTAINS
      ...
      ! nonlinear dynamic pressure:
        ...
        !$acc data copyin(xh,rxh,arh1,arh2,uh,vh,gz,rgz,gzv,gzu,mh,rho0,rr0,rf0,rrf0,rru,rrv,rrw,rds,rdsf,c1,c2,rho) &
        !$acc copyin(uf,vf,mf) &
        !$acc copyin(uten1,vten1,w3d,divx) &
        !$acc copy(dum1,dum2,dum3,dum4,dum5,dum6,dum7) &
        !$acc copy(vten,uten,wten) &
        !$acc copy(vdiag,udiag,wdiag,wprof) 
